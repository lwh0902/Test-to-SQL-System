...
CREATE TABLE IF NOT EXISTS analysis_tasks (
    ...
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, INDEX idx_task_scope (session_id, user_id, space_id)
...
) ENGINE=InnoDB COMMENT='多Agent工件';
